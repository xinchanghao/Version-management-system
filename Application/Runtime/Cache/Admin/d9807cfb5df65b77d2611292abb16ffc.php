...
<!--包含左侧菜单模版header-->
    ...
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse<?php if(CONTROLLER_NAME=='Index') echo ' in';?>">
            ...
            <li ><a href="privacy-policy.html">公司政策</a></li>
            <li ><a href="terms-and-conditions.html">关于我们</a></li>
        </ul>
...
<div class="content">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="appmodify.html">APP编辑</a> <span class="divider">/</span></li>
        </ul>
...
<div class="btn-toolbar">
    <button class="btn btn-primary" onclick="document.getElementById('modifyform').submit();"><i class="icon-save"></i> 提交</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    ...
    <form id="modifyform" method="post" action="<?php echo U('App/modifyok')?>"
        <label>应用ID</label>
        <input type="text" value="<?php echo ($data['AppID']); ?>" name="AppID" class="input-xlarge" maxlength="11" readonly>
        <label>应用名</label>
        <input type="text" value="<?php echo ($data['AppName']); ?>" name="AppName" class="input-xlarge">
        <label>用户ID</label>
        <input type="text" value="<?php echo ($data['UserID']); ?>" name="UserID" class="input-xlarge" maxlength="11">
        <label>内部名</label>
        <input type="text" value="<?php echo ($data['SymbolName']); ?>" name="SymbolName" class="input-xlarge">
        <label>分类</label>
        <select name="CategotyID" id="CategoryID" value="<?php echo ($data['CategoryID']); ?>" class="input-xlarge">
          <option value="12.0">聊天</option>
          ...
          <option value="3.5">输入法</option>
          <option value="3.0">安全杀毒</option>
          <option value="2.0">系统工具</option>
          <option value="1.0">其他</option>
        </select>
        <!--<label>图标</label>-->
        <!--<input type="file" value="<?php echo ($data['Pic']); ?>" name="Pic" class="input-xlarge">-->
         <label>描述</label>
        <textarea value="<?php echo ($data['AppDetail']); ?>" rows="3" name="AppDetail" class="input-xlarge"><?php echo ($data['AppDetail']); ?></textarea>
    </form>
      </div>
  </div>
