  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
        <div class="navbar-inner">
                ...
                <a class="brand" href="index.html"><span class="first">***应用商店</span> <span class="second">后台</span></a>
        </div>
    </div>
...
<div class="content">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="users.html">添加版本</a> <span class="divider">/</span></li>
    </ul>
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="btn-toolbar">
                <button class="btn btn-primary" onclick="javascript:document.getElementById('versioninfo').submit();"><i class="icon-save"></i> 提交</button>
                <div class="btn-group">
                </div>
            </div>
            <div class="well">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#home" data-toggle="tab">版本信息</a></li>
                </ul>
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="versioninfo" method="post" action="<?php echo U('Version/add',array('AppID'=>I('get.AppID')));?>">
                            <label>版本名</label>
                            <input type="text" value="" name="VersionName" class="input-xlarge" maxlength="11">
                            <label>更新时间</label>
                            <input type="text" value="" name="Time" class="input-xlarge">
                            <label>更新日志</label>
                            <textarea name="Log" value="" rows="3" class="input-xlarge"></textarea>
                            <label>备注</label>
                            <textarea name="Note" value="" rows="3" class="input-xlarge"></textarea>
                        </form>
                    </div>
                </div>
