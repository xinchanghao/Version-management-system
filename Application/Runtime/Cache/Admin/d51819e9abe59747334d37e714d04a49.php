        ...
        <div class="row-fluid">
            ...
            <div class="search-well pull-right" style="margin-right: 100px;margin-top: 6px;">
                <form class="form-inline"  method="post" action="<?php echo U('App/search')?>" id="sear">
                    <input class="input-xlarge" placeholder="输入您想查找的App..." id="appendedInputButton" type="text" >
            ...
            <div class="well">
                <table class="table table-bordered">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                            ...
                            <td>
                                <a href="<?php echo U('App/reviewok',array('AppID'=>$vo['AppID']))?>"><i class="icon-ok"></i></a>
                                <a href="#myModal" role="button" data-toggle="modal" id="test" data-AppID="<?php echo ($vo['AppID']); ?>" onClick="$('#DeleteBtn').data('appid',$(this).data('appid'));"><i class="icon-remove"></i></a>
                            </td>
            ...
            <div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-danger" id="DeleteBtn" onclick="jump($(this).data('appid'))"  data-dismiss="modal">Delete</button>
                </div>
            </div>
