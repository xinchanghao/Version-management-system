...
<div class="well">
    <table class="table table-bordered table-hover">
      ...
      <tbody>
          <tr>
              <td><input type="checkbox" name="users" value="<?php echo ($data['UserID']); ?>"></input></td>
              <td><a href="<?php echo U('User/modify',array('UserID'=>$vo['UserID']))?>"> <?php echo ($data["UserID"]); ?></a></td>
